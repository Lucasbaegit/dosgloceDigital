...
class ImanesCorteRectoPricingEngine:
    ...
    def __init__(self, bundle: ImanesCorteRectoBundle):
    ...
    def quote(self, request: ImanesCorteRectoQuoteInput) -> ImanesCorteRectoQuoteResult:
        ...
        trace = build_pdf_matrix_trace(
            ...
            fuente_precio_final="PDF página 15 - Imanes Corte Recto",
        ...
        return ImanesCorteRectoQuoteResult(
            ...
            regla_aplicada="IMANES_CORTE_RECTO_MATRIZ_PDF_P15",
            fuente="imanes_corte_recto_pdf_pagina_15",
            trazabilidad=trace,
        )
    ...
    def health(self) -> dict[str, Any]:
        return {"status": "ok", "rama": "imanes_corte_recto", "combinaciones": len(self._index)}
