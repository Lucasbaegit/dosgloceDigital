    ...
    def __init__(self, project_root: Path):
        ...
        self.catalog = {
            ...
            "click_color": {
                ...
                "max": 100000,
                "step": 0.01,
                "source_file": "data/variables_globales/costos_base.json",
                "path": ["click_color_base"],
                "source_path": "click_color_base",
                "applies_today": True,
                "confiabilidad": "alta",
                "productos_afectados": ["Stickers Circulares", "Stickers Corte Recto", "Imanes Corte Recto"],
                "impact": "Cambia el precio base estimado y la trazabilidad de productos con fórmula editable calibrada que usan click color.",
            },
            "obra_90g": {
                "group": "papeles",
